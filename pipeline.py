...
LUA_SHA1 = get_hash(os.path.join(CWD, 'suspilne.lua'))
...
project = Project(
    title='Suspilne',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/thumb/5/5e/Suspilne-logo.png/800px-Suspilne-logo.png" height="50px" title=""/>
        <h2>suspilne.media <span class="links"><a href="https://suspilne.media/">Website</a> &middot; <a href="http://tracker.archiveteam.org/suspilne/">Leaderboard</a></span></h2>
        <p>Archiving everything from Suspilne.</p>
    '''
)
